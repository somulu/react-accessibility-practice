...
class MovieWishlist extends Component {
  ...
  render() {
    ...
    const movieActions = getWishlistActions(
    ...
    return (
      <div>
        <header className='navbar navbar-dark bg-primary'>
          <span className='navbar-text'>Movie Wishlist</span>
          <nav>
            <button className='btn btn-outline-secondary' onClick={goToBrowse}>
              +
            </button>
          </nav>
        </header>
        ...
        <main>
          {Object.keys(wishlist).length ? (
            ...
            <p>
              No Movies in your Wish List! <Link to='/browse'>Add some</Link>!
            </p>
          )}
        </main>
